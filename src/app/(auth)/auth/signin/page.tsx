    ...
    <main className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-sm space-y-8">
        ...
        <div className="text-center">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-foreground">BrainHistory</h1>
          <p className="mt-2 text-sm text-neutral-500 dark:text-neutral-400">
            Save anything. Find it later with AI.
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 rounded-lg border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-900 px-4 py-2.5 text-sm font-medium text-neutral-800 dark:text-neutral-200 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors cursor-pointer"
            >
              <GoogleIcon />
